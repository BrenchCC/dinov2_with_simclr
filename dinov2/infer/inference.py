...
def parse_args(description):
    ...
    args_parser.add_argument('--model_type', type=str, default='dinov2', choices=['dinov2', 'dinov2_mlp'],
                             help='type of model')
...
def main():
    ...
    dataset = HDFSDataset(filepaths, make_classification_eval_transform(resize_size=cfg.crops.global_crops_size,
